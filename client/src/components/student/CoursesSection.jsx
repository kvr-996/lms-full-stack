...
const CoursesSection = () => {
  ...
  return (
    <div className="py-16 md:px-40 px-8">
      ...
      <div className='grid grid-cols-auto px-4 px-4 md:px-0 md:my-16 my-16 my-10 gap-4'>
...
/*grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-4 md:px-0 md:my-16 my-10 gap-4*/